"""home_credit_api URL Configuration
...
from api.views import predict_view, id_list
...
urlpatterns = [
    ...
    ##
    # THESE PATHS NEED AN EMAIL BACKEND SETUP
    ...
    # Wont work without email backend
    ##
    path("dashboard/", dash_views.dashboard, name="dashboard"),
    path('register/', mgmt_views.register, name='register'),
